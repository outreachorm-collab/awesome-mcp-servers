...
- <img src="https://greetu.io/favicon.svg" height="14"/> [Greetu](https://greetu.io/mcp) - The first MCP server for greeting cards. Create birthday, anniversary, and custom greeting cards with AI-generated messages. Supports webhooks, scheduling, and team CSV imports. Free tier with instant anonymous signup (20 credits). Works with Claude, ChatGPT, Gemini, Cursor.
